...
def hist_comparativo (l_data,l_k,l_colores,l_archivos,nombre): # Crear la función frecuencias con parámetros de entrada: lista de clases, lista de datos, archivo de datos, color del gráfico y nombre del archivo de entradas.
    ...
    plt.xlabel('Datos')
    plt.ylabel('Frecuencia absoluta')
    plt.title('Histograma Comparativo de '+nombre)
...
def main(ingreso=1):
    ...
    if ingreso==1:
        ...
        a_entradas="Ej_TF.txt"  
    elif ingreso=="p1":
        a_entradas="Temperaturas.txt" 
    elif ingreso=="T1":
        a_entradas="Turno_1.txt" 
    elif ingreso=="T2":
        a_entradas="Turno_2.txt" 
    elif ingreso=="T3":
        a_entradas="Turno_3.txt" 
